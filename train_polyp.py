...
from lib.networks import WBANetout
from utils1.dataloader import get_loader, test_dataset
from utils1.utils import clip_gradient, adjust_lr, AvgMeter
from utils1.pixel_contrast_cross_entropy_loss import ContrastCELoss
...
def train(train_loader, model, optimizer, epoch, test_path, model_name = 'WBANet'):
    model.train()
    global best
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            # loss_contrast = ContrastCELoss()(P1+P2+P3+P4, emb, gts)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float,
                        default=4e-5, help='learning rate')
    ...
    parser.add_argument('--batchsize', type=int,
                        default=7, help='training batch size')
    ...
    parser.add_argument('--train_path', type=str,
                        default='/home/lab347-server6/桌面/WYP/polyp_segments/ColonAttGLSAFormer-main/data/TrainDataset',
                        help='path to train dataset')

    parser.add_argument('--test_path', type=str,
                        default='/home/lab347-server6/桌面/WYP/polyp_segments/ColonFormer-main/data/TestDataset/',
    ...
    logging.basicConfig(filename='train_log_'+model_name+'3.log',
    ...
    print(optimizer)
    image_root = '{}/binaryimages/'.format(opt.train_path)
    gt_root = '{}/binarymasks/'.format(opt.train_path)
